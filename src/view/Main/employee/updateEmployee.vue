      ...
      <div class="containBox">
        <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" label-width="120px" class="demo-ruleForm"
          ...
          <el-row>
            ...
            <el-col :span="4"><el-form-item label="职位名称" prop="pName">
                <el-select v-model="ruleForm.ePositionID"  @change="selectChange" placeholder="请选择职位名称">
              ...
              <el-row :gutter="24">
                <el-col :span="12">
                  <el-form-item label="出身地" prop="eBornaddress">
                    <el-input v-model="ruleForm.eBornaddress" /> </el-form-item></el-col>
                <el-col :span="12"><el-form-item label="邮编" prop="ePostcode">
                    <el-input v-model="ruleForm.ePostcode" /> </el-form-item></el-col>
                ...
                <el-col :span="12"><el-form-item label="年龄" prop="eAge">
                    <el-input v-model="ruleForm.eAge" /> </el-form-item></el-col>
              </el-row>
            </el-col>
          </el-row>
          ...
          <el-row>
            ...
            <el-col :span="3"><el-form-item label="兴趣爱好" prop="eHobby">
                <el-input v-model="ruleForm.eHobby" placeholder="小黑子篮球" /> </el-form-item></el-col>
              ...
              <el-row>
                ...
                <el-col :span="24">
                  <el-form-item label="登记人" prop="eRecoders">
                    <el-select v-model="ruleForm.eRecoders" placeholder="请选择类别">
                      <el-option v-for="item in U_options" :key="item.value" :label="item.label" :value="item.value" />
                    </el-select>
                  </el-form-item>
                </el-col>
...
//引入请求网络函数
import { getL1L2L3, GetAllPosition, GetAllUser, Update ,GetAllType} from "../../../api/employee";
//引入vue的内部对象
